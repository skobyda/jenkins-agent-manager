...
public class ScriptDuringBuild extends io.jenkins.plugins.agentManager.Conditions.Script implements DuringBuildCondition {
    @DataBoundConstructor public ScriptDuringBuild(String scriptText) {
        super(scriptText);
    }
