...
public class HistoryTimeDuringBuild extends io.jenkins.plugins.agentManager.Conditions.HistoryTime implements DuringBuildCondition {
    @DataBoundConstructor
    public HistoryTimeDuringBuild(int quantity, long averageTime) {
