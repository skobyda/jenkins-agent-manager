...
public class NoConditionDuringBuild extends io.jenkins.plugins.agentManager.Conditions.NoCondition implements DuringBuildCondition {
    @DataBoundConstructor
    public NoConditionDuringBuild() {
        super();
    }
