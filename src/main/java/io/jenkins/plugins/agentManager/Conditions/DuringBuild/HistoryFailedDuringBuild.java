...
public class HistoryFailedDuringBuild extends io.jenkins.plugins.agentManager.Conditions.HistoryFailed implements DuringBuildCondition {
    @DataBoundConstructor
    public HistoryFailedDuringBuild(int quantity) {
        super(quantity);
    }
