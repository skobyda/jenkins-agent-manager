...
public class DiskSpaceDuringBuild extends io.jenkins.plugins.agentManager.Conditions.DiskSpace implements DuringBuildCondition {
    @DataBoundConstructor
    public DiskSpaceDuringBuild(long space, String unit) {
        super(space, unit);
    }
