...
public class HistoryFailedPreBuild extends io.jenkins.plugins.agentManager.Conditions.HistoryFailed implements PreBuildCondition {
    @DataBoundConstructor
    public HistoryFailedPreBuild(int quantity) {
        super(quantity);
    }
