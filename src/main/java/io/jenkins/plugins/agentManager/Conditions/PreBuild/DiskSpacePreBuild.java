...
public class DiskSpacePreBuild extends io.jenkins.plugins.agentManager.Conditions.DiskSpace implements PreBuildCondition {
    @DataBoundConstructor
    public DiskSpacePreBuild(long space, String unit) {
        super(space, unit);
    }
