...
public class RebootPostBuild extends io.jenkins.plugins.agentManager.Actions.Reboot implements PostBuildAction {
    @DataBoundConstructor public RebootPostBuild() {
        super();
    }
