...
public class SetOfflinePreBuild extends io.jenkins.plugins.agentManager.Actions.SetOffline implements PreBuildAction {
    @DataBoundConstructor public SetOfflinePreBuild() {
        super();
    }
