...
public class ShellScriptPostBuild extends io.jenkins.plugins.agentManager.Actions.ShellScript implements PostBuildAction {
    @DataBoundConstructor public ShellScriptPostBuild(String scriptText) {
        super(scriptText);
    }
