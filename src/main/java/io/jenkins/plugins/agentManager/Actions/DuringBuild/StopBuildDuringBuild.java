...
public class StopBuildDuringBuild extends io.jenkins.plugins.agentManager.Actions.StopBuild implements DuringBuildAction {
    @DataBoundConstructor public StopBuildDuringBuild() {
        super();
    }
