...
public class GroovyScriptDuringBuild extends io.jenkins.plugins.agentManager.Actions.GroovyScript implements DuringBuildAction {
    @DataBoundConstructor public GroovyScriptDuringBuild(String scriptText) {
        super(scriptText);
    }
