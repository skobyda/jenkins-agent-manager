...
public class GroovyScriptPostBuild extends io.jenkins.plugins.agentManager.Actions.GroovyScript implements PostBuildAction {
    @DataBoundConstructor public GroovyScriptPostBuild(String scriptText) {
        super(scriptText);
    }
