...
public class SetOfflinePostBuild extends io.jenkins.plugins.agentManager.Actions.SetOffline implements PostBuildAction {
    @DataBoundConstructor public SetOfflinePostBuild() {
        super();
    }
